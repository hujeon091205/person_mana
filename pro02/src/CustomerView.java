public class CustomerView {
    ...
    private void modifyCustomer(){
        System.out.println("enter modified number:");
...
//        int user_input=CMUtility.readInt();
//        char yn=CMUtility.readConfirmSelection();
//        if (yn=='N'){
//            return;
//        }else{
//            customers.deleteCustomer(user_input);
//
//        }
    }
    private void listAllCustomers() {
        ...
        if (custs.length == 0) {
            ...
            System.out.println(i + 1 + "\t" + custs[i].getName() + "\t" + custs[i].getSex() + "\t" + custs[i].getAge() + "\t\t" + custs[i].getPhone() + "\t" + custs[i].getEmail());
//                System.out.println((i+1) + "\t" + custs[i].getTotal());
            }
        }
